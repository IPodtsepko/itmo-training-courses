...
8. Примеры работы программы:
    ...
    | Monday's child is fair of face.<br>Tuesday's child is full of grace.  | monday's 1 1<br>child 2 2 8<br>is 2 3 9<br>fair 1 4<br>of 2 5 11<br>face 1 4<br>tuesday's 1 7<br>full 1 10<br>grace 1 22 |
...
Программа не должна «вылетать» с исключениями (как стандартными, так и доб6. авленными).

...
GNU - (Gnu is Not Unix) - проект, который собирались распространять под лицензией copyleft. Требовалось переписать всю ОС. Главное достижение - GCC, в это время Линус Торвальдс написал ядро Linux, а в проекте GNU никто не решался писать ядро ОС. Впоследствии два этих проекта объединились в GNU/Linux.

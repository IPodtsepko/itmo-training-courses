...
Различают статическое и динамическое. При статическом ресурсы выделяются при создании, а динамическое будем обсуждать в дальнейшем. Изоляция в будущем. Планирование через лекцию. Диспетчеризация на следующей. Межпроцессорное взаимодействие - сложная штука, мы уже с ней поработали, когда использовали конвейеры. 
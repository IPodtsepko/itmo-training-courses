...
GNU - (Gnu is Not Unix) - проект, который собирались распространять под лицензией copyleft, и должен был включать в себя новую ОС. Авторы решили переписать компилятор C - создали GCC, в это время Линус Торвальдс написал ядро Linux. Впоследствии два этих проекта объединились в GNU/Linux.
